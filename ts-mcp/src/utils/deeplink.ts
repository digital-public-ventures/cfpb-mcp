...
export const applyDefaultDates = (
	...
	if (
		params.date_received_min === undefined ||
		params.date_received_min === null
	) {
		params.date_received_min = DEFAULT_START_DATE;
	}
	if (
		params.date_received_max === undefined ||
		params.date_received_max === null
	) {
